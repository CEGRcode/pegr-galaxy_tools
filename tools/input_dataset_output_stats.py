...
stderr = ''
payload = stats_util.get_base_json_dict(args.config_file, args.dbkey, args.history_id, args.history_name, args.stats_tool_id, stderr, args.tool_id, args.tool_category, tool_parameters, args.user_email, workflow_step_id)
